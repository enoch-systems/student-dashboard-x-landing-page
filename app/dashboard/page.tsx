...
export default function DashboardPage() {
  ...
  // Total revenue: placeholder based on payment status count
  ...
  // Count students registered this time range
  ...
  return (
    <>
      ...
      {/* Metric Cards - Live from real data */}
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
        ...
        {/* Students Registered with Dropdown - Live from real data */}
        <div className="bg-card border border-border rounded-lg p-5 cursor-pointer hover:shadow-md transition-shadow">
          ...
          <p className="text-3xl font-semibold mb-2">
            {isLoading ? "..." : getStudentsRegisteredThisRange()}
          </p>
